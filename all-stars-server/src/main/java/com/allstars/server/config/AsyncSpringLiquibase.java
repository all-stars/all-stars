...
import static com.allstars.server.config.AllStarsConstants.SPRING_PROFILE_DEVELOPMENT;
import static com.allstars.server.config.AllStarsConstants.SPRING_PROFILE_HEROKU;
import static com.allstars.server.config.AllStarsConstants.SPRING_PROFILE_NO_LIQUIBASE;
